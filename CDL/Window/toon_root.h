...
Window __ToonGetKDEDesktop(Display *display, int screen, Window window, Atom atom, char *atomname, int depth)
{
  char *name = NULL;
  Atom *wintype = NULL;
  Window winreturn = 0;
...
Window ToonGetRoot(Display *dpy, int screen)
{
     Window client;
     return ToonGetRootWindow(dpy,screen,&client);
}
